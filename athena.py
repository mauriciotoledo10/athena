...
def passwordGenerator():
	color()
	print color.BOLD + 'Type the value of arguments:' + color.END
	arguments = raw_input('> ')
	url = 'http://api.predator.wtf/passgen/?arguments=' + arguments
	loading()
	webFile = urllib2.urlopen(url).read()
...
def clearConsole():
	#if you are using Windoes just change 'clear' to 'cls'
